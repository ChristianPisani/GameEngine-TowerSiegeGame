    ...
    public class Light2D : ILight2D
    {
        ...
        public Rectangle rectBounds
        {
            get
            {
                ...
                rect.X = (int)(this.mPosition.X - this.mRange);
                rect.Y = (int)(this.mPosition.Y - this.mRange);
                rect.Width = (int)(this.mPosition.X + this.mRange * 2);
                rect.Height = (int)(this.mPosition.Y + this.mRange * 2);
        ...
        public Rectangle selectionBounds()
        {
            ...
            selectionbounds.X = (int)Position.X - 10;
            selectionbounds.Y = (int)Position.Y - 10;
            selectionbounds.Width = 20;
            selectionbounds.Height = 20;
