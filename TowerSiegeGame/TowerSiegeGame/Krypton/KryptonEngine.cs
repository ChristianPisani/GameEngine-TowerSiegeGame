...
namespace TowerSiegeGame
{
    ...
    public class KryptonEngine : DrawableGameComponent
    {
        ...
        public List<ILight2D> mMovingLights = new List<ILight2D>();
        ...
        /// </summary>
        public void LightMapPrepare(Camera camera)
        {
            ...
            foreach (var light in this.mLights)
            {
                ...
                if (light.Bounds.Intersects(camera.boundingSize))
                {
            ...
            foreach (var light in this.mMovingLights)
            {
                // Loop through each light within the view frustum
                if (light.Bounds.Intersects(camera.boundingSize))
                {
